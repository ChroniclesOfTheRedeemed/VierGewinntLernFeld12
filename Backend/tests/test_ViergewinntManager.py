...
class TestGameManagement(TestCase):
    ...
    def test_challenge(self):
        ...
        print("challenges: ", game_manager.fetch_challengers_util(token))
        self.assertFalse("admin" in game_manager.fetch_challengers_util(token)[1])
        ...
        print("challenges: ", game_manager.fetch_challengers_util(token))
        self.assertTrue("admin" in game_manager.fetch_challengers_util(token)[1])
    ...
    def test_challenge_2(self):
        ...
        print("challenges: ", game_manager.fetch_challengers_util(token2))
        self.assertTrue("admin" in game_manager.fetch_challengers_util(token2)[1])
        ...
        print("challenges: ", game_manager.fetch_challengers_util(token2))
        self.assertTrue(len(game_manager.fetch_challengers_util(token)[1]) == 0)

        print("challenges: ", game_manager.fetch_challengers_util(token2))
        self.assertFalse("admina" in game_manager.fetch_challengers_util(token)[1])
    ...
    def test_challenge_3(self):
        ...
        game_manager.challenge(token, "admina")
        game_manager.challenge(token2, "admin")
        print(game_manager.fetch_challengers_util(token2), "chall")
        print(game_manager.fetch_challengers_util(token), "chall")
