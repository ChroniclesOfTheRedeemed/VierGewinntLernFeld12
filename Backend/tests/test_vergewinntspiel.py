...
# test draw
    def test_player1wins_vertically(self):
        self.game.playerMadeMove(4)
        self.game.playerMadeMove(3)
        self.game.playerMadeMove(4)
        self.game.playerMadeMove(3)
        self.game.playerMadeMove(4)
        self.game.playerMadeMove(3)

        self.assertFalse(self.game_ended())

        self.game.playerMadeMove(4)

        self.assertTrue(self.game_ended())
        self.assertTrue(self.game_ended())
        self.assertTrue(self.game_ended())

    def test_player2wins_vertically(self):
        self.game.playerMadeMove(1)
        self.game.playerMadeMove(3)
        self.game.playerMadeMove(4)
        self.game.playerMadeMove(3)
        self.game.playerMadeMove(4)
